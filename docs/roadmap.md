...
- Eval harness: a labelled set of ~20 recall questions with known-good answers, run against the store; precision tracked per change so quality is measured, not vibes. Prerequisite for tuning decay windows, thresholds, and the associative layer.
